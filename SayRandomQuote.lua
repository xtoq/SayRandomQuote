...
srq_quotes["summon"] = {
  ...
  "If you don't want me to run up there, aggro all those mobs, sacrifice my demon and run like hell, I suggest you click this portal.",
  ...
  "Scotty, beam %t up! Didn't work? Guess there's no intelligent life down here.",
  ...
  "Summoning noobs hasn't been tested before. Are you volunteering %t?",
  ...
  "You know %t, you can get a mount at level 20 now. Why? Oh, no reason. Just conversation.",
}
